...
class NewOrderRefundDetailVC: UIViewController {
    ...
    func calTotalTenders(card: [Grand]) -> Double {
    ...
    func getResponseValues(response: Any) {
        ...
        DispatchQueue.main.async {
            print(self.arrofRefCartData.count)
            ...
            self.refundtableHeight.constant = CGFloat(130 * self.arrofRefCartData.count)
    ...
    func setOrderDetails(order: OrderDetail) {
        ...
        small.append(c_code)
        print(c_code.loyalty_point_earned)
        couponCodeArr = small
        print(couponCodeArr)
    ...
    func setRefundData(refund_data: Any) {
        ...
        for ref in refund {
            ...
            print(reward_loyalty_refund_point)
        ...
        print(loyaltyRemove.count)
        print(smallrefundData.count)
